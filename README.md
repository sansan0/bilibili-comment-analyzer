...
**Q：二维码登录失败怎么办？**  
A：请确保网络连接正常，使用最新版本的 B 站手机 APP 扫码。如仍失败，可尝试手动获取 Cookie 填入(搜 bilibili cookie 手动获取)。
...
- 遵守 B 站用户协议和相关法律法规
- 尊重内容创作者权益，合理使用数据
- 控制请求频率，避免对 B 站服务器造成压力并为自身账号造成风险
...
扫码关注作者微信公众号，里面有的文章是专门讲我写的这些项目的，可以找找，咳如果看到不错的，记得献上【点赞,转发,推荐】三连，来支持一下作者的开发，顺便也可以反馈使用问题：
